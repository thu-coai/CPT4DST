            ...
            if return_dict_in_generate:
                ...
                if output_attentions:
                    ...
                    if self.config.is_encoder_decoder:
                        ...
                        # if len(cross_attentions) > 1:
                        #     print('from generate_utils, cross attention check')
                        #     print(cross_attentions[-1][0][:,:,:-1,:].shape, cross_attentions[-2][0].shape)
                        #     assert torch.all(cross_attentions[-1][0][:,:,:-1,:] == cross_attentions[-2][0]), \
                        #         print(cross_attentions[-1][0][:,:,:-1,:] == cross_attentions[-2][0])
